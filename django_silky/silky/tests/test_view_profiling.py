...
class TestProfilingViewGetObjects(TestCase):
    ...
    def test_ordering(self):
        ...
        ProfilingView()._get_objects(order_by='Name')
        self.assertSorted(results, 'name')
        ProfilingView()._get_objects(order_by='Function Name')
        self.assertSorted(results, 'func_name')
    ...
    def test_func_name(self):
        func_name = self.profiles[1].func_name
