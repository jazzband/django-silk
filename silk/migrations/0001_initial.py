    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "view_name",
                    models.CharField(
                        db_index=True, blank=True, default="", max_length=190, null=True
                    ),
                ),
                ("end_time", models.DateTimeField(blank=True, null=True)),
                ("time_taken", models.FloatField(blank=True, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="silk.SQLQuery", db_index=True, related_name="profiles"
            ),
        ),
        migrations.AddField(
            model_name="profile",
            ...
            field=models.ForeignKey(
                to="silk.Request", blank=True, null=True, on_delete=models.CASCADE
            ),
        ),
    ]
