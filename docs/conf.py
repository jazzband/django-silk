...
latex_documents = [
    ("index", "silk.tex", u"silk Documentation", u"Michael Ford", "manual"),
]
...
man_pages = [
    ("index", "silk", u"silk Documentation", [u"Michael Ford"], 1),
    ("profiling", "Profiling", u"Profiling", [u"Michael Ford"], 2),
]
