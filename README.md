...
This value can either be a function or a string representing the path to the function. Be wary of using a function directly as it will be evaluated before Django has added the app name to the prefix which could cause import errors.
...
SILKY_INTERCEPT_FUNC = 'my_app.path_to_module.my_custom_logic'

# Or assuming the function is defined in the settings module:
